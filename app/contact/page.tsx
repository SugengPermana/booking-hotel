    ...
    <div>
      ...
      <div className="max-w-screen-xl mx-auto py-20 px-4">
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h1 className="text-lg text-gray-500 mb-3"></h1>
            <h1 className="text-5xl font-semibold text-gray-900 mb-4">Get In Touch Today</h1>
            <p className="text-gray-700 py-5">Lorem ipsum dolor sit amet consectetur adipisicing elit. Excepturi magni temporibus quos fuga nihil aperiam rerum suscipit inventore in delectus dicta ipsum sed, tempore eligendi libero illum. Temporibus, tenetur corrupti.</p>
              ...
              <li className="flex gap-5">
                <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <p>+9992 2919 1292, +9992 2132 4141</p>
                  </div>
              </li>
              <li className="flex gap-5">
                <div className="flex-none bg-gray-300 p-3 shadow-sm rounded-sm">
                  ...
                  <div className="flex-1">
                    ...
                    <p>Jambu street Road 2025, Tangerang, INDONESIA</p>
                  </div>
              </li>
            </ul>
          </div>
