...
const CheckoutDetail = async ({reservationId} : {reservationId: string}) => {
  ...
  const duration = differenceInCalendarDays(reservation.endDate, reservation.starDate)
        ...
        <table className="w-full">
          <tbody>
            ...
            <tr>
              ...
              <td className="py-2 text-right truncate">{formatDate(reservation.starDate.toISOString())}</td>
            </tr>
            <tr>
