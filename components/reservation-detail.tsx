        ...
        <table className="w-full text-sm text-left text-gray-500">
          ...
          <tbody>
            <tr className="bg-white border-b">
              ...
              <td className="px-6 py-4">{formatDate(reservation.starDate.toISOString())}</td>
              <td className="px-6 py-4">{formatDate(reservation.endDate.toISOString())}</td>
              <td className="px-6 py-4">{differenceInCalendarDays(reservation.endDate, reservation.starDate)} Night</td>
