      ...
      {session?.user ? (
        <div className="flex items-center justify-end md:order-2">
          ...
          <div className="flex items-center">
            <button
              onClick={() => signOut()}
              className="md:block hidden py-2 px-4 bg-gray-50 text-gray-700 hover:text-gray-500 rounded-sm cursor-pointer"
            >
              Sign Out
            </button>
          </div>
          ...
          {session ? (
            <>
              ...
              <li className="pt-2 md:pt-0">
                <button
                  onClick={() => signOut()}
                  className="md:hidden px-4 py-2.5 bg-orange-400 text-white hover:bg-red-600 rounded-sm cursor-pointer"
                >
                  Sign Out
                </button>
              </li>
